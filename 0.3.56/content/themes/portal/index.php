...
<?php
	 ...
	 * menampilkan jenis html yg digunakan berdasarkan library yang digunakan
	 */
?>
...
<link href="<?php get_stylesheet_directory_uri(true); ?>/css/style.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="<?php get_stylesheet_directory_uri(true); ?>/js/ajaxtabs.js"></script>
<script type="text/javascript" src="<?php get_stylesheet_directory_uri(true); ?>/js/menu.js"></script>
<script type="text/javascript" src="<?php get_stylesheet_directory_uri(true); ?>/js/jquery.min.js"></script>
<script type="text/javascript" src="<?php get_stylesheet_directory_uri(true); ?>/js/jquery-ui.min.js"></script>
<script>
$(function() {
...
<div id="header">
<div class="left"><a class="imagelogo" href="#"></a></div>
<div class="right">
<div class="ad468x60"><a href="#" target="_blank"><img src="<?php get_stylesheet_directory_uri(true); ?>/images/ads/ads468x60.jpg"></a></div>
</div>
</div>
<div id="headline">
