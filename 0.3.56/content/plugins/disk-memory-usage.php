...
function convert_graphic($memory){	
	...
	<div class="widget progress_anim" style="width: '.$memory['percent'].'%;height:99%;background:'.$memory['color'].' ;border-width:0px;text-shadow:0 1px 0 #000000;color:#FFFFFF;text-align:right;"><div style="padding:4px">'.$memory['percent'].'%</div></div>
	</div>
	</div>';
	endif; 
}
...
<div class="padding">
<!--Show Dialog-->
<div id="dialog_disk_memory_overview"  class="redactor_modal" style="width: 300px; height: auto;display: none; ">
...
<label for="txtDiskLimit">Disk Limit Host : </label>
<input id="txtDiskLimit" name="txtDiskLimit" type="text" style="width:50px" value="<?php echo $disk_limit;?>" /> MByte<br />
<input id="log_submit" type="submit" name="submitDiskLimit" value="Submit" class="button on l" /><input type="reset" name="Reset" value="Reset" class="button r" />
</form>
</div>
</div>
<!--Show End Dialog-->
