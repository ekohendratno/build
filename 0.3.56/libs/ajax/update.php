...
class update_system {
	...
	protected $url_server = "http://localhost/cmsid/server/2.1/4/";
	protected $server;
	...
	function message($data){		
		$print = '<table width="100%" border="0" cellspacing="0" cellpadding="0">';
  		$print.= '<tr>';
   		$print.= '<td width="10%" valign="top"><img src="libs/img/icon-download-upgrade.png" style="margin-top:2px;"></td>';
