...
if(isset($_POST['submit'])){
	...
	$data = compact('sitename','sitedescription','sitekeywords','site_copyright','admin_email','datetime_format','timeout','author','account_registration','timezone','avatar_type','robots','toogle_menuaction','toogle_menutop','welcome');
	set_general( $data );
