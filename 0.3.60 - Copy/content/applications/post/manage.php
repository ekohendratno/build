...
$(function(){
	...
	$('#post_opt_show').click( function(){
		$('#post_opt_show_content').slideToggle();
	});
});
/*]]>*/
</script>
...
?>
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td style="width:70%"><label for="title">Judul: <span class="required">*</span></label><br /><input type="text" id="title" name="title" value="" placeholder="Judul Posting" required style="width:99%;" /></td>
      <td align="right"></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="2">*( : Jika type posting {page} option ini diabaikan<br /><span class="required">*</span> : Harus diisini</td>
    </tr>
  </table>
</div>
<?php
...
if( $type != 'page' ):
$menu_widget = '<a id="post_opt_show" href="#" class="button button2">Show</a>';
$widget_manual['gadget'][] = array('title' => 'Options','menu' => $menu_widget, 'desc' => '
<div class="padding" id="post_opt_show_content" style="display:none;">
...
?>
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td style="width:70%"><label for="title">Judul: <span class="required">*</span></label><br /><input type="text" id="title" name="title" value="<?php echo sanitize_title($row['title'])?>" placeholder="Judul Posting" required style="width:99%;" /></td>
      <td align="right">
      <?php if( $type != 'page' ):?>
      <label for="category">Kategori: <span class="required">*</span> </label><br />
        <select id="category" name="category">
