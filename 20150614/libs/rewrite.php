	...
	&& $rewrite_link ):	
		...
		if($app=='login' || $app=='logout'):
			...
			if(!empty($pg) && !empty($cat_id) && !empty($id) && !empty($view)):
				//?p=string&view=string&cat_id=string&id=string&pg=0
				$link = '?p='.$app.'&view='.$view.'&cat_id='.$cat_id.'&id='.$id.'&pg='.$pg; 
			elseif(!empty($pg) && !empty($id) && !empty($view)):
				//?p=string&view=string&id=string&pg=0
				$link = '?p='.$app.'&view='.$view.'&id='.$id.'&pg='.$pg; 
			elseif(!empty($pg) && !empty($view)):
				//?p=string&view=string&pg=0
				$link = '?p='.$app.'&view='.$view.'&pg='.$pg; 
			elseif(!empty($cat_id) && !empty($id) && !empty($view)):
				//?p=string&view=string&cat_id=string&id=string
				$link = '?p='.$app.'&view='.$view.'&cat_id='.$cat_id.'&id='.$id; 
			elseif(!empty($id) && !empty($view) && !empty($go) && !empty($to)):
				//?p=string&view=string&id=string&go=0&to=0
				$link = '?p='.$app.'&view='.$view.'&id='.$id.'&go='.$go.'&to='.$to;  
			elseif(!empty($id) && !empty($view) && !empty($go)):
				//?p=string&view=string&id=string&go=0
				$link = '?p='.$app.'&view='.$view.'&id='.$id.'&go='.$go; 
			elseif(!empty($id) && !empty($view)):
				//?p=string&view=string&id=string
				$link = '?p='.$app.'&view='.$view.'&id='.$id; 
			elseif(!empty($id)):
				//?p=string&id=string
				$link = '?p='.$app.'&id='.$id; 
			elseif(!empty($view)):
				//?p=string&view=string
				$link = '?p='.$app.'&view='.$view; 
			else:
				//?p=string
				$link = '?p='.$app; 
			endif;
