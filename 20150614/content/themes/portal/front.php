...
$dFrontArtikel	= array('id'=>$wFrontArtikel->id,'title'=>$wFrontArtikel->title);
?>
  	<div class="archive">
    	...
    	<div class="thumb left">
    		<a href="<?php echo do_links('postdetail',$dFrontArtikel);?>" rel="bookmark"><img src="<?php echo site_url().'/?request&load=libs/timthumb.php&src=' . $thumb; ?>&amp;h=100&amp;w=100&amp;zc=1" alt="" style="width:100px; height:100px;" /></a>
    	</div> <!--end: thumb-->
      	<h2><a href="<?php echo do_links('postdetail',$dFrontArtikel);?>" rel="bookmark"><?php echo $wFrontArtikel->title; ?></a></h2>
