...
<body>
<div id="header">
<div class="left"><a class="imagelogo" style="width:<?php echo theme_option('logo_w');?>px; height:<?php echo theme_option('logo_h');?>px;" href="<?php echo site_url('/')?>"><img src="<?php echo theme_option('logo');?>"></a></div>
<div class="right">
<?php if( theme_option('ads468x60') ):?>
<div class="ad468x60">
<a href="#" target="_blank"><img src="<?php echo theme_option('ads468x60');?>"></a>
</div>
<?php endif;?>
</div>
</div>
