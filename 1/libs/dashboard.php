...
function dashboard_update_info(){ 
    ...
    ?>	
	<div class="padding">
	<p>Versi system anda <?php echo $version_system . ' '.$version_project.' '.$version_beta.' build '.$version_beta;?>, pastikan versi yang anda pakai adalah versi terbaru, agar situs anda aman dan mengurangi kemungkinan masalah yang ada pada situs anda.</p>
