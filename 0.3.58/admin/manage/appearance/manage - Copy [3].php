...
<tr <?php echo $warna?> class="isi">
    ...
    <td valign="top">
    <div class="action">
<a href="?admin&sys=appearance&go=widgets&act=del&sidebar_id=<?php echo $widgets['sidebar_id']?>&widget_id=<?php echo $widget_id?>&widget_key=<?php echo $widgets['widget_key']?>" class="delete" title="delete" onclick="return confirm('Are You sure delete this post?')">delete</a>
    </div></td>
</tr>
<?php
}
