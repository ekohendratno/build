...
?>
	<tr class="isi" <?php echo $warna;?>>
	  ...
	  echo '<a href="?admin=single&sys=applications&go=edit&app_name='.$name.'&file=/'.$key2[1].'" title="Open this file in the Plugin Editor" class="button button2  '.$style_button.'">Edit File</a><a href="?admin&sys=applications&act=del&app_name='.$name.'" title="Delete this plugin" onclick="return confirm(\'Are You sure delete this applications?\')" class="button button2 right">Delete</a>';
	  ?>      
      </td>
