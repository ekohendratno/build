...
$header_menu  = '
<a href="?admin=single&sys=installer" class="button left"><span class="icon_head back">&laquo; Back</span></a>
<a href="?admin=single&sys=installer&type='.$type.'" class="button middle">+ Instal Baru</a>
<a href="?admin=single&sys='.$type.'" class="button on right">Manage '.uc_first($type).'</a>';
}else{	
$header_menu  = '
<a href="?admin" class="button left">Dashboard</a>
<a href="?admin=single&sys=applications" class="button middle">Manage Applications</a>
<a href="?admin=single&sys=plugins" class="button right">Manage Plugins</a>'; 
}

$form = 'enctype="multipart/form-data" action="" method="post"';
add_templates_manage( $content, 'Installer Manager', $header_menu, null, $form, 'full-single' );
