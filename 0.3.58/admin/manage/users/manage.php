...
<?php
$header_menu = '<a href="?admin&sys=users" class="button button3 left"><span class="icon_head back">&laquo; Back</span></a>';
$header_menu.= '<div class="header_menu_top"><input type="submit" name="submit" class="button on m blue" value="Save &amp; Update"><input class="button r" type="reset" name="Reset" value="Reset"></div>';
