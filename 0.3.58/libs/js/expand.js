...
$.fn.expandAll.defaults = {
        ...
        cllpsEl : '#post-right .widget-inside', // the collapsible element
        trigger : '#post-right .widget-action', // if expandAll() is used in conjunction with toggle() - the elements that contain the trigger of the toggle effect on the individual collapsible sections
...
$.fn.toggler.defaults = {
     cllpsEl : '#post-right div.widget-inside',
     method : 'slideToggle',
     speed : 'slow',
