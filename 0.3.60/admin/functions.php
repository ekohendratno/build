...
<!--http://help.cmsid.org/?frame=full&video=demo-->
<iframe
	src="http://localhost/cmsid/help/?frame=full&video=demo" 
...
<div id="dashboard-notification" class="gd">
    ...
    <div class="dn-content-cols">
        <div class="cols" style="background: #f8f8f8;margin-right: 5px;padding: 2px; border-right:1px solid #ddd; padding-left:20px; text-align:center;">
