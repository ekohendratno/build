...
<form action="" method="post">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td colspan="2"><label for="judul">Judul: <span class="required">*</span></label><input type="text" id="judul" name="title" placeholder="Judul Posting" required="required" style="width:97%;" /></td>
    </tr>
    <tr>
      <td colspan="2"><label for="isi">Isi:</label><textarea id="editor_quick_post" name="isi" style="height:100px;width:97%;"></textarea></td>
    </tr>
    <tr>
      <td width="45%">
...
<div style="float:right"><input onclick="return confirm(\'Are You sure delete all records?\')" id="rec_submit" type="submit" name="submitReferalClear" value="Set to Empty" class="button" /></div>';
