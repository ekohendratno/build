...
<a href="?admin=single&sys=installer&set_mode='.$set_mode.'" class="button middle">+ Instal Baru</a>
<a href="?admin=single&sys='.$set_mode.'" class="button on right">Manage '.uc_first($set_mode).'</a>';
}else{	
$header_menu  = '
