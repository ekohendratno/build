...
<?php if(is_admin() && get_option('jumpapp') == 1 ):?>
...
<div class="p head">Actions</div><div class="plr"><ul class="menu-box">
<?php		
if( isset($widget['menu']) && count($widget['menu']) > 0 && !empty($widget['menu']) ) {
	...
	$aside_menu = array_multi_sort($aside_menu, array('title' => SORT_ASC));
