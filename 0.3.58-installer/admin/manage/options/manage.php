...
if(isset($_POST['submit'])){
	...
	$jumpapp				= filter_txt($_POST['jumpapp']);
	
	$data = compact('sitename','sitedescription','sitekeywords','site_copyright','admin_email','datetime_format','timeout','author','account_registration','timezone','avatar_type','jumpapp');
	set_general( $data );
