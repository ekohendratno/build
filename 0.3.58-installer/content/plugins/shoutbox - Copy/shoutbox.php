...
<form id="formShoutBox">
    <table width="100%">
        <tr><td colspan="2">
        <div id="divShoutBoxList" style="border:1px solid #ddd;overflow:auto;height:120px;"><center><div id="loading" align="center"></div>
        ...
        <input type="text" value=225 name=text_num disabled="disabled" size="3" readonly="readonly" > huruf lagi
        </td></tr>
        <tr><td valign="top">&nbsp;</td><td>
...
function shoutbox_today(){
	...
	$sql = $db->query( "SELECT * FROM $db->shoutbox WHERE day(`waktu`) = '$day' ORDER BY waktu DESC LIMIT 30" );
